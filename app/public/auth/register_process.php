...
if ($result->num_rows > 0) {
    ...
    if ($password != $password2) {
        ...
        $insert_sql = "INSERT INTO usuario (idrol, nombre, email, password) VALUES (1, ?, ?, ?)";
        ...
        if ($insert_stmt->execute()) {
            ...
            echo "<script>alert('Error al registrar el usuario: " . $insert_stmt->error . "'); window.history.back();</script>";
        }
